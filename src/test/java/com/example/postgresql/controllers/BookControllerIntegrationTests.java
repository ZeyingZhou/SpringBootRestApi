...
import com.example.postgresql.services.BookService;
...
public class BookControllerIntegrationTests {
    ...
    @Test
    public void testThatUpdateBookReturnsUpdatBook() throws Exception {
        BookDto bookDto = TestDataUtil.createTestBookDtoA(null);
        String createBookJson = objectMapper.writeValueAsString(bookDto);
    ...
    public void testThatDeleteNonExistingBookReturnsHttpStatus204NoContent() throws Exception{
        mockMvc.perform(
                MockMvcRequestBuilders.delete("/books/egrerge")
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
