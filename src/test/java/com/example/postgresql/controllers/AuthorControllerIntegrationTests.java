...
import com.example.postgresql.services.AuthorService;
...
public class AuthorControllerIntegrationTests {
    ...
    @Test
    public void testThatGetAuthorReturnsHttpStatus404NoAuthorExist() throws Exception {
        mockMvc.perform(
    ...
    @Test
    public void testThatFullUpdateAuthorReturnsHttpStatus404NoAuthorExist() throws Exception {
        AuthorDto testAuthorDtoA = TestDataUtil.createTestAuthorDtoA();
        String authorDtoJson = objectMapper.writeValueAsString(testAuthorDtoA);
        mockMvc.perform(
